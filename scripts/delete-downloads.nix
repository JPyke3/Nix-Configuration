...
pkgs.writeShellScriptBin "clean-downloads-folder" ''
  ...
  # Remove all files that are older than 30 days and ignroe the syncthing .stfolder or .stignore
  find . -type f -not -path "./.stfolder/*" -not -path "./.stignore/*" -mtime +30 -delete
